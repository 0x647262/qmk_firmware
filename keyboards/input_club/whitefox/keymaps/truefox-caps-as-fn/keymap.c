...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_ansi_blocker_split_bs(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,     QK_BOOT,               KC_VOLU,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,     KC_PGUP,      KC_VOLD,
        _______, _______, _______,                            _______,                            _______, KC_CAPS,     KC_HOME, KC_PGDN,      KC_END
    )
};
